...
Vagrant.configure("2") do |config|
  ...
  # documentation for more information about their specific syntax and use.
    config.vm.provision "shell", inline: <<-SHELL
      ...
      apt install ./postgresql-client-8.4_8.4.22-8.pgdg18.04+1_amd64.deb -y
      DEBIAN_FRONTEND=noninterecrive apt install ./postgresql-8.4_8.4.22-8.pgdg18.04+1_amd64.deb -y
    SHELL
end
